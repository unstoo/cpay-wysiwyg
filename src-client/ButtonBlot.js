...
render() {
  return <button onClick={() => { 
      ...
      // let href = prompt('Enter link URL for your button.')
      ...
      // debugger
      quill.setSelection(selection.index + 1, selection.length, Quill.sources.SILENT);
      quill.format('buttonContainer', '5m')
      }}>
      {'Button'}
    </button>
  }
